/*
  ...
  1. New Tables
    - `employees`
      ...
      - `cost_center` (varchar, optional)
      - `role` (varchar, required)
      - `employee_type` (varchar, required - Full-time, Part-time, Contract, Intern)
      - `location` (varchar, required)
      - `billing_status` (varchar, required - Billable, Non-billable, Overhead)
  ...
  3. Sample Data
    - Three sample employees for testing
*/
